...
//            }
//
//            NdefRecord nfcRecord = toNfcRecord(ndefRecords[i]);
//            if (nfcRecord != null) nfcRecords.add(nfcRecord);
//        }
//
//        nfcMessage.data = new NdefRecord[nfcRecords.size()];
...
//     */
//    private static NdefRecord toNdefRecord(NdefRecord record) throws InvalidNfcMessageException,
//                                                                    IllegalArgumentException,
//                                                                    UnsupportedEncodingException {
//        switch (record.recordType) {
//            case NfcRecordType.URL:
//                return NdefRecord.createUri(new String(record.msg, getCharset(record)));
//            case NfcRecordType.TEXT:
//                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
//                    return NdefRecord.createTextRecord(
//                            "en-US", new String(record.msg, getCharset(record)));
//                } else {
//                    return NdefRecord.createMime(TEXT_MIME, record.msg);
//                }
//            case NfcRecordType.JSON:
//            case NfcRecordType.OPAQUE_RECORD:
//                return NdefRecord.createMime(record.mediaType, record.msg);
//            default:
//                throw new InvalidNfcMessageException();
//        }
//    }
...
//     */
//    private static NdefRecord toNfcRecord(NdefRecord ndefRecord)
//            throws UnsupportedEncodingException {
...
//        nfcRecord.msg = uri.toString().getBytes();
//        return nfcRecord;
//    }
//
//    /**
...
//            return null;
//        }
//        nfcRecord.msg = Arrays.copyOfRange(text, textBodyStartPos, text.length);
//        return nfcRecord;
//    }
//
//    /**
...
//     */
//    private static NdefRecord createWellKnownRecord(NdefRecord record) {
